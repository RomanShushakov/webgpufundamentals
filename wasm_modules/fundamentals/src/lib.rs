...
impl Scene
{
        ...
        -> Result<Self, JsValue>
    {
        ...
        render_shader_module_descriptor.set_label("Our hardcoded red triangle shaders");
        ...
        render_pipeline_descriptor.set_label("Our hardcoded red triangle pipeline");
    ...
    {        
        ...
        render_pass_descriptor.set_label("Our basic canvas render pass");
