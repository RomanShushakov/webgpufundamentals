...
impl Scene
{
        ...
        -> Result<Self, JsValue>
    {
        ...
        render_shader_module_descriptor.set_label("triangle shaders with uniforms");
        ...
        render_pipeline_descriptor.set_label("triangle with uniforms");
        ...
        {
            let static_uniform_buffer_descriptor = GpuBufferDescriptor::new(
                static_uniform_buffer_size.into(),
                UNIFORM | COPY_DST,
            );
            static_uniform_buffer_descriptor.set_label(&format!("static uniforms for obj: {}", i));
            ...
            uniform_buffer_descriptor.set_label(&format!("uniforms for obj: {}", i));
            ...
            bind_group_0_descriptor.set_label(&format!("bind group 0 for obj: {}", i));
