...
use web_sys::
{
    ...
    GpuRenderPassDescriptor, GpuRenderPipeline,
};
...
impl Scene
{
    pub fn create(
        ...
        -> Result<Self, JsValue>
    {
        let vert_shader_module_descriptor = GpuShaderModuleDescriptor::new(&include_str!("../shader/vert.wgsl"));
        vert_shader_module_descriptor.set_label("hardcoded triangle");
        let vert_shader_module = gpu_device.create_shader_module(&vert_shader_module_descriptor);

        let frag_shader_module_descriptor = GpuShaderModuleDescriptor::new(&include_str!("../shader/frag.wgsl"));
        frag_shader_module_descriptor.set_label("checkerboard");
        let frag_shader_module = gpu_device.create_shader_module(&frag_shader_module_descriptor);

        let vertex_state = GpuVertexState::new(&vert_shader_module);
        ...
        let fragment_state = GpuFragmentState::new(&frag_shader_module, &fragment_state_targets);
        ...
        render_pipeline_descriptor.set_label("hardcoded checkerboard triangle pipeline");
    ...
    pub fn render(&self) -> Result<(), JsValue>
    {
        ...
        color_attachment.set_clear_value(&GpuColorDict::new(1.0, 1.0, 0.0, 0.0));
